...
|RF-07| A aplicação deve permitir o auto gerenciamentos do usuários. | Alta |
|RF-08| Para cada despesa cadastrada, o tipo e a forma de pagamento deve ser informado. | Alta |
...
|RF-13| A aplicação deve ter um campo que ofereça uma perspectiva de futuro para o usuário de quanto ele terá em X anos, se ele economizar o valor Y ao final de cada mês. | Média |
